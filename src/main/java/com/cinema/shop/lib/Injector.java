...
public class Injector {
    ...
    private Injector(String mainPackageName) {
        try {
            ...
            throw new RuntimeException("Can't getById information about all classes", e);
        }
    }
    ...
    private boolean isFieldInitialized(Field field, Object instance) {
        ...
        try {
            ...
            throw new RuntimeException("Can't getById access to field");
        }
    }
